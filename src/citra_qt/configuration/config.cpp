...
// clang-format off
const std::array<UISettings::Shortcut, 44> QtConfig::default_hotkeys {{
     ...
     {QStringLiteral("Capture 3D Screenshot"),   QStringLiteral("Main Window"), {QStringLiteral(""),       Qt::WidgetWithChildrenShortcut}},
